...
export default function AddAddress() {
  ...
  const handleOnSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const isValidated = handleValidationOF(addressValidate, formData);
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white px-4">
      <div className="w-full max-w-md">
        {/* Heading */}
        <h1 className="text-3xl font-bold text-center mb-2">Add School Address</h1>
        <p className="text-center text-gray-600 mb-8">Please enter your school location details.</p>
