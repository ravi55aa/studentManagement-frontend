...
import { addressValidate, centerSchema } from '@/validation/school.validator';
...
const AddCenter = () => {
  ...
  const handleAddAddressSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const isValidated = //!cross check given data
      handleValidationOF(addressValidate, formData);
  ...
  return (
    <div className="p-6 bg-white min-h-screen">
      ...
      {!util?.openAddress && (
        <>
          <h1 className="text-2xl font-semibold text-gray-800 mb-1 underline">Add New Center</h1>
      ...
      {/* Error */}
      {util?.error?.trim() && <p className="text-red-600 text-sm mb-4">{util.error}</p>}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="w-full flex flex-wrap">
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-sm text-gray-700">Is Main</span>
                <span id="isMain" className="text-sm text-gray-700"></span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span id="isActive" className="text-sm text-gray-700"></span>
              </div>
            </div>
          </div>
      ...
      {util.openAddress && (
        <div className="flex justify-center items-center min-h-screen bg-white px-4">
          <div className="w-full   max-w-md">
            <h1 className="text-3xl font-bold text-center mb-2">Add Center Address</h1>
                  ...
                  return (
                    <InputField
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                        _useAppHandleInputChange(e, setFormData);
                      }}
                      name={ele.name}
                      type={ele.type}
