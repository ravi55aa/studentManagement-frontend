...
export default function UploadDocuments() {
  ...
  const handleOnSubmit = async (e: React.MouseEvent<HTMLElement>) => {
    ...
    const res = await handleDocsUploadCreateSchoolApi(formData);
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white px-4">
      <div className="w-full max-w-xl">
        {/* Heading */}
        <h1 className="text-3xl font-bold text-center mb-2">Upload Documents</h1>
        ...
        <div className="flex flex-col gap-6">
          ...
          <button
            ...
            className="w-full bg-[#05A845] text-white font-semibold py-3 rounded-md mt-4 hover:bg-green-700"
          >
