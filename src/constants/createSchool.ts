export const inputStyle =
  'w-full border px-4 py-2 rounded-md focus:ring-2 focus:ring-green-600 outline-none';
...
export const inputStyleRegisterSchoolAddress =
  'border border-gray-300 rounded-md px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-green-700 w-full';
